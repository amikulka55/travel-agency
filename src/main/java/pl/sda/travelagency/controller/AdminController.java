...
public class AdminController {
    ...
    private final TripService travelService;
    ...
    public AdminController(TripService travelService, ContinentService continentService, CountryService countryService, CityService cityService, HotelService hotelService,
